...
- [Terraform Sym Provider Version 2 Upgrade Guide](#terraform-sym-provider-version-2-upgrade-guide)
  ...
  - [Provider: Configuration](#provider-configuration)
    - [skip_requesting_account_id Argument Now Required to Skip Account ID Lookup Errors](#skip_requesting_account_id-argument-now-required-to-skip-account-id-lookup-errors)
  - [Data Source: aws_ami](#data-source-aws_ami)
    - [owners Argument Now Required](#owners-argument-now-required)
  - [Data Source: aws_ami_ids](#data-source-aws_ami_ids)
    - [owners Argument Now Required](#owners-argument-now-required-1)
  - [Data Source: aws_iam_role](#data-source-aws_iam_role)
    - [assume_role_policy_document Attribute Removal](#assume_role_policy_document-attribute-removal)
    - [role_id Attribute Removal](#role_id-attribute-removal)
    - [role_name Argument Removal](#role_name-argument-removal)
  - [Data Source: aws_kms_secret](#data-source-aws_kms_secret)
    - [Data Source Removal and Migrating to aws_kms_secrets Data Source](#data-source-removal-and-migrating-to-aws_kms_secrets-data-source)
  - [Data Source: aws_lambda_function](#data-source-aws_lambda_function)
    - [arn and qualified_arn Attribute Behavior Changes](#arn-and-qualified_arn-attribute-behavior-changes)
  - [Data Source: aws_region](#data-source-aws_region)
    - [current Argument Removal](#current-argument-removal)
  - [Resource: aws_api_gateway_api_key](#resource-aws_api_gateway_api_key)
    - [stage_key Argument Removal](#stage_key-argument-removal)
  - [Resource: aws_api_gateway_integration](#resource-aws_api_gateway_integration)
    - [request_parameters_in_json Argument Removal](#request_parameters_in_json-argument-removal)
  - [Resource: aws_api_gateway_integration_response](#resource-aws_api_gateway_integration_response)
    - [response_parameters_in_json Argument Removal](#response_parameters_in_json-argument-removal)
  - [Resource: aws_api_gateway_method](#resource-aws_api_gateway_method)
    - [request_parameters_in_json Argument Removal](#request_parameters_in_json-argument-removal-1)
  - [Resource: aws_api_gateway_method_response](#resource-aws_api_gateway_method_response)
    - [response_parameters_in_json Argument Removal](#response_parameters_in_json-argument-removal-1)
  - [Resource: aws_appautoscaling_policy](#resource-aws_appautoscaling_policy)
    - [Argument Removals](#argument-removals)
  - [Resource: aws_autoscaling_policy](#resource-aws_autoscaling_policy)
    - [min_adjustment_step Argument Removal](#min_adjustment_step-argument-removal)
  - [Resource: aws_batch_compute_environment](#resource-aws_batch_compute_environment)
    - [ecc_cluster_arn Attribute Removal](#ecc_cluster_arn-attribute-removal)
  - [Resource: aws_cloudfront_distribution](#resource-aws_cloudfront_distribution)
    - [cache_behavior Argument Removal](#cache_behavior-argument-removal)
  - [Resource: aws_cognito_user_pool](#resource-aws_cognito_user_pool)
    - [email_verification_subject Argument Now Conflicts With verification_message_template Configuration Block email_subject Argument](#email_verification_subject-argument-now-conflicts-with-verification_message_template-configuration-block-email_subject-argument)
    - [email_verification_message Argument Now Conflicts With verification_message_template Configuration Block email_message Argument](#email_verification_message-argument-now-conflicts-with-verification_message_template-configuration-block-email_message-argument)
    - [sms_verification_message Argument Now Conflicts With verification_message_template Configuration Block sms_message Argument](#sms_verification_message-argument-now-conflicts-with-verification_message_template-configuration-block-sms_message-argument)
  - [Resource: aws_dx_lag](#resource-aws_dx_lag)
    - [number_of_connections Argument Removal](#number_of_connections-argument-removal)
  - [Resource: aws_ecs_service](#resource-aws_ecs_service)
    - [placement_strategy Argument Removal](#placement_strategy-argument-removal)
  - [Resource: aws_efs_file_system](#resource-aws_efs_file_system)
    - [reference_name Argument Removal](#reference_name-argument-removal)
  - [Resource: aws_elasticache_cluster](#resource-aws_elasticache_cluster)
    - [availability_zones Argument Removal](#availability_zones-argument-removal)
  - [Resource: aws_iam_user_login_profile](#resource-aws_iam_user_login_profile)
    - [Import Now Required For Existing Infrastructure](#import-now-required-for-existing-infrastructure)
  - [Resource: aws_instance](#resource-aws_instance)
    - [network_interface_id Attribute Removal](#network_interface_id-attribute-removal)
  - [Resource: aws_lambda_function](#resource-aws_lambda_function)
    - [reserved_concurrent_executions Argument Behavior Change](#reserved_concurrent_executions-argument-behavior-change)
  - [Resource: aws_lambda_layer_version](#resource-aws_lambda_layer_version)
    - [arn and layer_arn Attribute Value Swap](#arn-and-layer_arn-attribute-value-swap)
  - [Resource: aws_network_acl](#resource-aws_network_acl)
    - [subnet_id Argument Removal](#subnet_id-argument-removal)
  - [Resource: aws_redshift_cluster](#resource-aws_redshift_cluster)
    - [Argument Removals](#argument-removals-1)
  ...
  - [Resource: aws_route53_record](#resource-aws_route53_record)
    - [allow_overwrite Default Value Change](#allow_overwrite-default-value-change)
  - [Resource: aws_route53_zone](#resource-aws_route53_zone)
    - [vpc_id and vpc_region Argument Removal](#vpc_id-and-vpc_region-argument-removal)
  - [Resource: aws_wafregional_byte_match_set](#resource-aws_wafregional_byte_match_set)
    - [byte_match_tuple Argument Removal](#byte_match_tuple-argument-removal)
