		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("sym_flow.this", "params[0].allowed_sources_json", `["slack","api"]`),
					...
					resource.TestCheckResourceAttr("sym_flow.this", "params[0].prompt_fields_json", `[{"name":"reason","type":"string","required":true,"label":"Reason"},{"name":"urgency","type":"list","required":true,"default":"Low","allowed_values":["Low","Medium","High"]}]`),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("sym_flow.this", "params[0].allow_revoke", "true"),
					resource.TestCheckResourceAttr("sym_flow.this", "params[0].schedule_deescalation", "false"),
					resource.TestCheckNoResourceAttr("sym_flow.this", "params[0].allowed_sources_json"),
					resource.TestCheckResourceAttr("sym_flow.this", "params[0].prompt_fields_json", `[{"name":"reason","type":"string","required":true,"label":"Reason"},{"name":"urgency","type":"list","required":true,"default":"Low","allowed_values":["Low","Medium","High"]}]`),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair("sym_flow.this", "params[0].strategy_id", "sym_strategy.sso_main", "id"),
					resource.TestCheckResourceAttr("sym_flow.this", "params[0].allow_revoke", "true"),
					resource.TestCheckResourceAttr("sym_flow.this", "params[0].allowed_sources_json", `["api"]`),
					resource.TestCheckResourceAttr("sym_flow.this", "params[0].prompt_fields_json", `[{"name":"reason","type":"string","required":true,"label":"Reason"},{"name":"urgency","type":"list","required":true,"default":"Low","allowed_values":["Low","Medium","High"]}]`),
				),
			},
			{
